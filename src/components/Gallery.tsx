...
const Gallery = () => {
  ...
  const galleryItems = [
    ...
    { id: 9, title: 'Encimera de Cocina en Cuarzo', category: 'granito', year: 2024, image: 'https://images.unsplash.com/photo-1588854337236-6889d631faa8?auto=format&fit=crop&w=800' },
    { id: 10, title: 'Baño Minimalista', category: 'baño', year: 2023, image: 'https://images.unsplash.com/photo-1620626011761-996317b8d101?auto=format&fit=crop&w=800' },
    { id: 11, title: 'Comedor Ejecutivo', category: 'comedor', year: 2024, image: 'https://images.unsplash.com/photo-1617806118233-18e1de247200?auto=format&fit=crop&w=800' },
    { id: 12, title: 'Piso Porcelanato Rectificado', category: 'cerámica', year: 2023, image: 'https://images.unsplash.com/photo-1524230659092-07f99a75c013?auto=format&fit=crop&w=800' },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-6">
            Nuestros <span className="text-amber-700">Proyectos</span>
          </h2>
          <p className="text-xl text-stone-600 max-w-3xl mx-auto">
            Inspírate con nuestros trabajos realizados para clientes que confiaron 
            en nuestra experiencia y calidad. Cada proyecto es único.
          </p>
        </div>
            ...
            <div className="flex bg-white rounded-full p-1 border border-stone-200">
              <button
                ...
                className={`p-3 rounded-full transition-all ${
                  viewMode === 'grid' ? 'bg-amber-600 text-white' : 'text-stone-700 hover:bg-stone-100'
                }`}
              ...
              <button
                ...
                className={`p-3 rounded-full transition-all ${
                  viewMode === 'list' ? 'bg-amber-600 text-white' : 'text-stone-700 hover:bg-stone-100'
                }`}
        ...
        <div className={`mb-12 ${
          ...
          {searchedItems.map((item) => (
            ...
            >
              <div className={`relative ${
                viewMode === 'list' ? 'w-1/3 min-h-[300px]' : 'h-64'
              }`}>
                <img
                  src={item.image}
                  alt={item.title}
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-stone-900 to-stone-800 rounded-2xl p-12 text-center text-white">
          <h3 className="text-3xl font-bold mb-4">¿Listo para transformar tu espacio?</h3>
          <p className="text-stone-300 mb-8 max-w-2xl mx-auto">
            Cada proyecto es una oportunidad para crear algo único. Déjanos ayudarte a materializar tu visión.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-amber-600 hover:bg-amber-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all hover:scale-105 hover:shadow-xl">
              Solicitar Proyecto Personalizado
            </button>
            <button className="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-lg font-semibold text-lg border-2 border-white/30 transition-all hover:shadow-xl">
